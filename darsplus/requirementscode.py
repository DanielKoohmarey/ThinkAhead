...
def remainingRequirements(takenClasses, college, major):
	...
	# College of Letters and Sciences
		...
		if (major=='COMPSCI'):
			...
			if(udcsnum>=2) or ((udcsnum+design)>=3):
			...
			if(udeenum>=2) or ((udeenum+udcsnum)>=4) or ((udeenum+udcsnum+design)>=5):
			...
			if(tenum>=2) or ((tenum+udeenum)>=4)or((tenum+udeenum+udcsnum)>=6) or ((tenum+udeenum+udcsnum+design)>=7):
